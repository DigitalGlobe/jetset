  ...
  return {
    ...
    getRouteConfig: ( methodKey, ...args ) => {
      ...
      return typeof config === 'string'
        ? { method: methodDict[ methodKey ], route: config, getData: options.getData || ( data => data ), onError: options.onError || (error => error) }
        : {
          ...config,
          ...
          onError: config.onError || options.onError || ( error => error )
        };
    }
  };
}
